...
Anonymous vs. signed-in (thresholds in `wrangler.toml`): anonymous ≤ 1 MB, ≤ 7 days, 20/hr & 50/day, must keep a password; signed-in ≤ 2 MB, permanent links, no daily cap.
