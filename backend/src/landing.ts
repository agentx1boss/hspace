...
const L: Record<Lang, Record<string, string>> = {
  ...
  zh: {
    ...
    faqQ2: "内容存在哪里?保留多久?", faqA2: "内容经 HTTPS 传输,存储在 Cloudflare 全球边缘(R2);密码只存单向哈希,不存明文。每条链接都会过期(这是刻意设计):匿名最长 7 天,登录最长 30 天且可在到期前续期;没有永久链接。你也可以随时手动删除,链接立即失效。",
    faqQ3: "发错了 / 不想给某人看了怎么办?", faqA3: "随时改密码(旧密码立即失效)或直接删除。用「每人一链」时,可以只撤销某一个人的密码,其他人不受影响。",
    faqQ4: "免费吗?有什么限制?", faqA4: "核心能力现在全部免费——密码分享、合集、访问回执、每人一链、版本化,都不阉割。匿名即用:单文件 ≤ 1MB、最长 7 天有效、每天 50 次;禁止钓鱼与恶意内容,违规会被下架。所有链接都会过期(不做永久托管),登录后最长 30 天、可续期。未来更长有效期、自定义品牌、团队空间会面向 Pro / Team,核心能力永远免费、开源可自建。",
