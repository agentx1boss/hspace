...
const L: Record<Lang, Record<string, string>> = {
  en: {
    ...
    desc: "Share what AI writes — without losing control. Private links, passwords, revocable, expiring, with read receipts. Targeted sharing for Cursor / Claude Code developers.",
    ogTitle: "HSpace — Ship to one, not to all.",
    ogDesc: "Share what AI writes — without losing control. Private links, passwords, revocable, expiring, with read receipts.",
    ...
    heroLead: "Share what AI writes — without losing control. HSpace gives AI-built HTML demos and Markdown docs private links, passwords, revocable access, expiring links, and read receipts.",
    ...
    s2sub: "Nothing to install — they open the link to a clean, formatted reading page; collections add a table of contents and cross-doc nav.",
    ...
    featSub: "Content is born in your editor and AI chats — sharing should happen there too.",
  ...
  zh: {
    ...
    desc: "AI 写的稿，发出去也不失控：密码链接、可撤回、会过期、看谁打开了。为 Cursor / Claude Code 开发者而生的定向分享。",
    ogTitle: "HSpace — 稿出即递,点开即读,心里有数",
    ogDesc: "AI 写的稿，发出去也不失控：密码链接、可撤回、会过期、看谁打开了。",
    ...
    heroLead: "AI 写的稿，发出去也不失控：密码链接、可撤回、会过期、看谁打开了。HSpace 把 HTML demo、Markdown 方案变成只给该看的人打开的定向分享。",
    ...
    s2h: "对方那边:输一次密码,通览全部",
    s2sub: "对方什么都不用装,点开就是排好版的阅读页;多篇还自带目录与篇间导航。",
    ...
    featH: "为 AI 编程工作流而生",
    featSub: "内容诞生在编辑器和 AI 对话里,分享也应该在那里发生。",
